...
const Cart = () => {
  ...
  // const deleteItem = (id) => {
  //   // Add your logic to delete an item here
      ...
      {Cart && Cart.length === 0 && (
        <div className='h-screen'>
          <div className='h-[100%] flex items-center justify-center flex-col'>
            ...
            <img
              src='https://thumbs.dreamstime.com/b/empty-cart-icon-328026679.jpg'
              alt='Empty cart'
              className='lg:h-[50vh]'
            />
          </div>
      ...
      <div className='mt-4 w-full flex items-center justify-end'>
        <div className='p-4 bg-zinc-800 rounded'>
          ...
          <div className='w-[100%] mt-3'>
            <button className='bg-zinc-100 rounded px-4 py-2 flex justify-center w-full font-semibold hover:bg-zinc-200' onClick={PlaceOrder}>Place Your Order
